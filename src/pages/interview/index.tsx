...
import InterviewPlayground from "@/components/playground/InterviewPlayground";
...
export function HomeInner() {
  ...
  const handleConnect = useCallback(
    async (c: boolean, mode: ConnectionMode, opts?: { metadata?: string }) => {
      c ? connect(mode, opts?.metadata) : disconnect();
    },
    [connect, disconnect]
  );
        ...
        {showPG ? (
          ...
          >
            <InterviewPlayground
              ...
              onConnect={(c: boolean, opts?: { metadata?: string }) => {
